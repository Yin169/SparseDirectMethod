...
int main() {
    ...
    const int gridSize = 30;  // 30x30 grid = 900 nodes
    ...
    try {
        ...
        std::cout << "\nThis implementation now creates multiple fronts based on the elimination tree\n"
                  << "for better parallelization. Each node in the elimination tree corresponds to a front,\n"
                  << "and fronts with no dependencies can be processed in parallel." << std::endl;
